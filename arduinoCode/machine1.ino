...
const char* password = "0875762200";
...
{  
    ...
    digitalWrite(LED2_G,status1);
    //digitalWrite(LED2_R,!status1);
    if(lastState_ultrasonic == 0 && RangeInCentimeters <= 3 ){
        state_ultrasonic = 1;
        which = 1;
        _post(which,state_ultrasonic);
        
        Serial.print("ultranic1 ");
